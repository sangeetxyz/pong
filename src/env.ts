...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_MAX_MULTIPLIER: z.string(),
  ...
  runtimeEnv: {
    ...
    MAX_MS: process.env.MAX_MS,
    MAX_MULTIPLIER: process.env.MAX_MULTIPLIER,
    NEXT_PUBLIC_MAX_MULTIPLIER: process.env.NEXT_PUBLIC_MAX_MULTIPLIER,
